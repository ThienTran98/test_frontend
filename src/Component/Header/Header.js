...
export default function Header() {
  return (
    <div className="absolute w-full py-10 px-[120px] flex items-center justify-between ">
      <div>
        <img src={logo} alt="" />
      </div>
      <div>
      ...
      <div>
        <ul className="flex items-center text-[15px]">
          <li className="flex items-center text-color-1  px-8 py-[14px] rounded-3xl border border-white hover:opacity-50 hover:cursor-pointer">
